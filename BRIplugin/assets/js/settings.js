    ...
    for (var label = 0; label < labels.length; label++) {
      ...
      <div class='card-header' id='heading" +
        ...
        " \
          ...
          <input type='checkbox' " +
        checkbox[settings[Constants.labels[labels[label]]].status] +
        " class = 'toggle-script' id='" +
        labels[label].replace(" ", "") +
        "' data-offstyle='success' data-onstyle='danger' data-on='Disabled' data-off='Enabled' data-toggle='toggle'> </div>\
        </h5>  \
      </div>  \
      <div> \
      <div id='collapse" +
